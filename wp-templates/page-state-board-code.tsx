...
import { StateCodePDF } from '@/components/StateCodePDF'

export default function StateBoardCodePage(props) {
  console.log({props})
...
StateBoardCodePage.variables = ({ databaseId }, ctx) => {
  return {
    databaseId,
