  ...
  return (
    <FadeIn>
      <div className={`h-fit w-full bg-${color}`}>
        <div
          className={`relative sm:px-10 px-[60px] mx-auto flex max-w-[1240px] flex-col items-center justify-center module-spacing-top-${spaceTop} module-spacing-bottom-${spaceBottom}`}
        >
